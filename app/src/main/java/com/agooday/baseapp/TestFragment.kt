...
class TestFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?) {
        ...
        recycler_view.adapter = FastAdapter(listData, arrayListOf(R.layout.item_test,R.layout.item_header),object :FastAdapter.OnBindView{
            override fun onBindView(type: Int, i: Int, holder: RecyclerView.ViewHolder) {
                if(type == FastAdapter.DATA_TYPE){
                    ...
                    holder.itemView.findViewById<TextView>(R.id.header).text = listData[i].header
                }
